> # ⚠️ 已废弃（2026-08-13 制作人拍板）
>
> 本手册所述 VoxCPM 管线已降级为**离线备选**。当前**唯一推荐**配音管线为 **MiniMax T2A v2**，详见 `docs/MiniMax语音生成工具手册.md`。
>
> **阿风等角色已迁移至 MiniMax 音色 A（`afeng_design_a_v1`）**，不再走 VoxCPM。
>
> 下方全文内容**仅作离线备选参考保留**（VoxCPM/MiMo 技术参数与用法仍然有效），未经制作人确认不得作为正式配音依据。
...
## ⚠️ 管线优先级更新（2026-08-06 制作人拍板，2026-08-13 升级为废弃）
...
> 📌 2026-08-13 升级：本手册正式标记为**已废弃**，仅作离线备选参考。阿风等角色已迁移至 MiniMax 音色 A（`afeng_design_a_v1`），详见本页顶部横幅。
