...
T = [
    ...
    # A4 角色自主表达测试（2026-08-10 制作人定稿）：ELDER_QUEST_RETURN_DIALOGUE 承接版开头两句
    ("elder", "quest_return_01", "来了。你爷爷的事，我们接着聊。"),
    ("elder", "quest_return_02", "昨天那个石头后面，我就知道你会来。"),
    ...
    ("adventurer", "adv_01", "嘿！还记得我不？小时候后山那一圈，就是我带你跑熟的。"),
